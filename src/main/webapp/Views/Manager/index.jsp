...
<div class="w-full min-h-screen bg-[#EEEEEE] flex ">
    ...
    <div class=" w-3/4 min-h-full ">
        <iframe class="w-full h-full" src="https://embed.lottiefiles.com/animation/40668"></iframe>
    </div>
        ...
        >
            ...
            <div class="w-full md:w-full lg:w-1/2 mx-auto md:mx-0 flex justify-center items-center">
                <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
                    ...
                    <form action="${pageContext.request.contextPath}/ManagerLogin" class="w-full" method="post">
                        ...
                        <div id="button" class="flex flex-col w-full my-5">
                            <button
                                    type="submit"
                                    class="w-full py-4 bg-[#0055A6] rounded-lg text-white"
                            >
